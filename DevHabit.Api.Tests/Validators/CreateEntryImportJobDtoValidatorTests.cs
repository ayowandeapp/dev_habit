...
namespace DevHabit.Api.Tests.Validators
{
    ...
    {
        private readonly CreateEntryImportJobDtoValidator _createEntryImportJobDto = new();
        ...
        public async Task Validate_ShouldNotReturnError_WhenAllPropertiesAreValid()
        {
            ...
            // Act
            TestValidationResult<CreateEntryImportJobDto> result = await _createEntryImportJobDto.TestValidateAsync(dto);
